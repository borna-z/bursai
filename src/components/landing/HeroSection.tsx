...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12 grid md:grid-cols-2 gap-12 md:gap-16 items-center pt-28 pb-20 relative z-10">
        {/* Left — Content */}
        <div className="flex flex-col gap-6 text-center md:text-left">
          <h1 className="text-5xl sm:text-6xl lg:text-[5.5rem] font-bold tracking-[-0.04em] leading-[0.95] text-white font-space reveal-up visible">
            {t('landing.hero')}
          </h1>

          <p className="text-base sm:text-lg text-gray-400 font-light max-w-md leading-relaxed tracking-wide mx-auto md:mx-0 reveal-up visible" style={{ '--reveal-delay': '80ms' } as React.CSSProperties}>
            {t('landing.hero_desc')}
          </p>

          {/* Primary CTA */}
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto pt-2 reveal-up visible" style={{ '--reveal-delay': '140ms' } as React.CSSProperties}>
            <button
              onClick={() => navigate('/auth')}
              className="group w-full sm:w-auto px-10 py-4 bg-white text-[#030305] rounded-full font-semibold tracking-wide hover:scale-[1.03] transition-transform duration-300 flex items-center justify-center gap-2.5 text-sm"
            >
          ...
          {/* SSO */}
          <div className="flex flex-col sm:flex-row items-center gap-3 reveal-up visible" style={{ '--reveal-delay': '200ms' } as React.CSSProperties}>
        ...
        {/* Right — Phone mockup */}
        <div className="hidden md:flex justify-center items-center reveal-scale visible" style={{ '--reveal-delay': '200ms' } as React.CSSProperties}>
          <div className="phone-mockup">
            <img
              src={appScreenshot}
              alt="BURS app home screen"
