...
export function ChatInput({
  ...
  // Report own height to parent for scroll padding
  useEffect(() => {
  ...
  // Publish height as CSS var so messages area can add bottom padding
  useEffect(() => {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-x-0 bottom-0 z-30 animate-fade-in px-4 pt-2 bg-background/80 backdrop-blur-xl"
      style={{
