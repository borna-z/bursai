...
export function ChatInput({
  ...
  // includes keyboard-offset padding). The scroll area only needs to clear
  // the card + a small margin, not the keyboard gap.
  useEffect(() => {
  ...
  useEffect(() => {
    // Card height + pt-2 (8px) + safe-area-inset-bottom (handled by CSS env)
