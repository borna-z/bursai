  ...
  return (
    <div className="px-4 pb-3 pt-2 shrink-0 animate-fade-in">
      <div className="max-w-lg mx-auto">
        <div className="relative rounded-2xl border border-border/50 bg-background/60 backdrop-blur-md shadow-sm">
          ...
          <div className="flex items-end gap-1 px-2 py-2">
            ...
            <textarea
              ...
              rows={1}
              className="flex-1 resize-none bg-transparent text-sm leading-relaxed py-2 px-1 outline-none placeholder:text-muted-foreground/60 max-h-32 min-h-[36px]"
            />
            <Button
              onClick={onSend}
        ...
        <p className="text-center text-[10px] text-muted-foreground/60 mt-1.5">{t('chat.disclaimer')}</p>
      </div>
    </div>
  );
}
