...
const PRICE_MAP: Record<string, PriceEntry> = {
  ...
  fi: { monthly: 6.99, yearly: 59.99, symbol: '€', prefix: false, decimals: 2, separator: ',' },
  de: { monthly: 6.99, yearly: 59.99, symbol: '€', prefix: false, decimals: 2, separator: ',' },
  fr: { monthly: 6.99, yearly: 59.99, symbol: '€', prefix: false, decimals: 2, separator: ',' },
  es: { monthly: 6.99, yearly: 59.99, symbol: '€', prefix: false, decimals: 2, separator: ',' },
  it: { monthly: 6.99, yearly: 59.99, symbol: '€', prefix: false, decimals: 2, separator: ',' },
  pt: { monthly: 6.99, yearly: 59.99, symbol: '€', prefix: false, decimals: 2, separator: ',' },
