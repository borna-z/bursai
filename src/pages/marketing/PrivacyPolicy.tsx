      ...
      <main className="flex-1 max-w-xl mx-auto px-4 py-10 w-full">
        ...
        >
          <div className="space-y-10 text-[15px] leading-relaxed text-muted-foreground">
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">1. Who We Are</h2>
              ...
              <p className="mt-3">If you have questions about this Privacy Policy or your personal data, contact us at <a href="mailto:hello@burs.me" className="hover:underline text-foreground">hello@burs.me</a>.</p>
            </section>

            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">2. Scope of This Privacy Policy</h2>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">3. What Data We Collect</h2>
              <p>We collect only the data needed to provide and improve BURS.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">A. Account and Identity Data</h3>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">B. Wardrobe and User Content</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">C. Usage and Device Data</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">D. Weather / Context Data</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">E. Google Calendar Data (only if you connect Google)</h3>
              ...
              <p className="mt-2">Google OAuth scope used (intended):<br /><code className="text-xs px-1.5 py-0.5 rounded bg-secondary">https://www.googleapis.com/auth/calendar.readonly</code></p>
              <p className="mt-2">BURS does not request permission to create, edit, or delete your Google Calendar events.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">F. Payment and Billing Data</h3>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">4. How We Use Your Data</h2>
              <p>We use personal data to operate BURS and provide the features you expect.</p>
              <p className="mt-3">We use your data to:</p>

              <h3 className="font-medium mt-3 mb-1 text-foreground">1. Provide the core Service</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1 text-foreground">2. Power AI styling features</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1 text-foreground">3. Provide contextual recommendations</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>use weather context</li>
                <li>use calendar context (if connected) to suggest appropriate outfits</li>
              </ul>

              <h3 className="font-medium mt-3 mb-1 text-foreground">4. Manage subscriptions and payments</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1 text-foreground">5. Support and troubleshoot</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1 text-foreground">6. Comply with legal obligations</h3>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">5. Legal Bases for Processing (GDPR)</h2>
              <p>Under the GDPR, we process personal data only when we have a legal basis.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">A. Contract (Article 6(1)(b))</h3>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">B. Consent (Article 6(1)(a))</h3>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">C. Legitimate Interests (Article 6(1)(f))</h3>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">D. Legal Obligation (Article 6(1)(c))</h3>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">6. Google API Services User Data (Important)</h2>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Google User Data — What We Access</h3>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Google User Data — What We Do NOT Do</h3>
              <p>BURS does not:</p>
              <ul className="list-disc pl-6 space-y-1 mt-1">
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Limited Use Commitment</h3>
              <p>BURS's use and transfer of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="hover:underline text-foreground">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">If We Change Google Data Use</h3>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">7. AI and Automated Recommendations</h2>
              <p>BURS uses AI/ML systems to generate wardrobe insights and outfit suggestions.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">Transparency Notice</h3>
              <p>When you use styling recommendations, you are interacting with AI-assisted features.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">How AI is used</h3>
              <p>AI may:</p>
              <ul className="list-disc pl-6 space-y-1 mt-1">
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Human decision remains yours</h3>
              <p>BURS provides suggestions only. Final clothing choices are always made by you.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">No solely automated legal/significant decisions</h3>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">8. Sharing of Data</h2>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Categories of recipients</h3>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">9. International Data Transfers</h2>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">10. Data Security</h2>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">11. Your Rights (GDPR)</h2>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Sweden (IMY)</h3>
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">How to exercise your rights</h3>
              <p>Email us at <a href="mailto:hello@burs.me" className="hover:underline text-foreground">hello@burs.me</a>. We may need to verify your identity before completing your request.</p>
            </section>

            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">12. Data Retention</h2>
              <p>We keep personal data only as long as necessary for the purposes described in this Privacy Policy.</p>

              <h3 className="font-medium mt-4 mb-1 text-foreground">Typical retention approach</h3>
              <ul className="list-disc pl-6 space-y-1 mt-1">
              ...
              <h3 className="font-medium mt-4 mb-1 text-foreground">Account deletion</h3>
              <p>You can request account deletion by using in-app settings (if available) or emailing <a href="mailto:hello@burs.me" className="hover:underline text-foreground">hello@burs.me</a>.</p>
            </section>

            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">13. Cookies and Similar Technologies</h2>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">14. Children's Privacy</h2>
              ...
              <p className="mt-2">If you believe a child has provided personal data to BURS, contact us at <a href="mailto:hello@burs.me" className="hover:underline text-foreground">hello@burs.me</a>.</p>
            </section>

            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">15. Changes to This Privacy Policy</h2>
            ...
            <section>
              <h2 className="font-display italic text-[1.3rem] leading-tight text-foreground mb-3">16. Contact</h2>
              <p>Burs<br />Email: <a href="mailto:hello@burs.me" className="hover:underline text-foreground">hello@burs.me</a></p>
            </section>
