    ...
    <div style={{ background: '#F5F0E8', color: ink }}>
      ...
      <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <main className="flex-1 max-w-3xl mx-auto px-4 py-12 md:py-20 w-full">
          <h1 className="text-3xl md:text-4xl font-bold mb-2" style={{ fontFamily: "'Playfair Display', serif", color: ink }}>Privacy Policy for BURS</h1>
          <p className="mb-2" style={{ color: muted }}>Effective date: 25 February 2026</p>
          <p className="mb-10" style={{ color: muted }}>Last updated: 25 February 2026</p>
          ...
          <div className="space-y-10 text-[15px] leading-relaxed" style={{ color: muted }}>
            ...
            <section>
              ...
              <p className="mt-3">If you have questions about this Privacy Policy or your personal data, contact us at <a href="mailto:hello@burs.me" className="hover:underline" style={{ color: ink }}>hello@burs.me</a>.</p>
            </section>
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>B. Wardrobe and User Content</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>C. Usage and Device Data</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>D. Weather / Context Data</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>E. Google Calendar Data (only if you connect Google)</h3>
              ...
              <p className="mt-2">Google OAuth scope used (intended):<br /><code className="text-xs px-1.5 py-0.5 rounded" style={{ background: surf }}>https://www.googleapis.com/auth/calendar.readonly</code></p>
              <p className="mt-2">BURS does not request permission to create, edit, or delete your Google Calendar events.</p>

              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>F. Payment and Billing Data</h3>
            ...
            <section>
              ...
              <h3 className="font-medium mt-3 mb-1" style={{ color: ink }}>1. Provide the core Service</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1" style={{ color: ink }}>2. Power AI styling features</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1" style={{ color: ink }}>3. Provide contextual recommendations</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>use weather context</li>
                <li>use calendar context (if connected) to suggest appropriate outfits</li>
              </ul>

              <h3 className="font-medium mt-3 mb-1" style={{ color: ink }}>4. Manage subscriptions and payments</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1" style={{ color: ink }}>5. Support and troubleshoot</h3>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <h3 className="font-medium mt-3 mb-1" style={{ color: ink }}>6. Comply with legal obligations</h3>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>B. Consent (Article 6(1)(a))</h3>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>C. Legitimate Interests (Article 6(1)(f))</h3>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>D. Legal Obligation (Article 6(1)(c))</h3>
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>Google User Data — What We Do NOT Do</h3>
              <p>BURS does not:</p>
              <ul className="list-disc pl-6 space-y-1 mt-1">
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>Limited Use Commitment</h3>
              <p>BURS's use and transfer of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="hover:underline" style={{ color: ink }}>Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>If We Change Google Data Use</h3>
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>How AI is used</h3>
              <p>AI may:</p>
              <ul className="list-disc pl-6 space-y-1 mt-1">
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>Human decision remains yours</h3>
              <p>BURS provides suggestions only. Final clothing choices are always made by you.</p>

              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>No solely automated legal/significant decisions</h3>
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>Categories of recipients</h3>
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>Sweden (IMY)</h3>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>How to exercise your rights</h3>
              <p>Email us at <a href="mailto:hello@burs.me" className="hover:underline" style={{ color: ink }}>hello@burs.me</a>. We may need to verify your identity before completing your request.</p>
            </section>
            ...
            <section>
              ...
              <h3 className="font-medium mt-4 mb-1" style={{ color: ink }}>Account deletion</h3>
              <p>You can request account deletion by using in-app settings (if available) or emailing <a href="mailto:hello@burs.me" className="hover:underline" style={{ color: ink }}>hello@burs.me</a>.</p>
            </section>
        ...
        <footer style={{ borderTop: '1px solid #DDD8CF' }}>
          <div className="max-w-3xl mx-auto px-4 py-8 flex flex-col items-center gap-4 text-xs" style={{ color: muted }}>
            <div className="flex gap-6">
              <span className="font-medium" style={{ color: ink }}>Privacy Policy</span>
              <Link to="/terms" className="hover:text-[#1C1917] transition-colors">Terms of Service</Link>
