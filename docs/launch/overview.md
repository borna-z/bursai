...
| Field | Value |
|-------|-------|
| **CURRENT WAVE** | M37 — Outfit detail slots (full composition + anchor UI) |
| **CURRENT WAVE FILE** | [`waves/m37-outfit-detail-slots.md`](waves/m37-outfit-detail-slots.md) |
| **STATUS** | TODO |
...
| M36 | [Calendar sync (Google OAuth)](waves/m36-calendar-sync.md) | DONE (PR #PR_NUM) | V0 |
