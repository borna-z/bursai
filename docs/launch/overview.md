...
| Field | Value |
|-------|-------|
| **CURRENT WAVE** | M22 — Wardrobe Aging → Insights |
| **CURRENT WAVE FILE** | [`waves/m22-wardrobe-aging.md`](waves/m22-wardrobe-aging.md) |
| **STATUS** | TODO |
...
| M21 | [Assess condition → GarmentDetail](waves/m21-assess-condition.md) | DONE (PR #TBD) | V0, M9 |
