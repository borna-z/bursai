...
| Field | Value |
|-------|-------|
| **CURRENT WAVE** | M4 — Duplicate detection |
| **CURRENT WAVE FILE** | [`waves/m4-duplicate-detection.md`](waves/m4-duplicate-detection.md) |
| **STATUS** | TODO |
...
| Wave | File | Status | Depends on |
|---|---|---|---|
| M13 | [Outfit anchor locking + rules engine](waves/m13-outfit-rules-anchor.md) | TODO | V0, M9 |
...
| Wave | File | Status | Depends on |
|---|---|---|---|
| M16 | [Outfit pool + week generator](waves/m16-pool-week-generators.md) | TODO | V0, M13, M15 |
| M17 | [Compositional helpers (flatlay + accessories + combinations + clone DNA)](waves/m17-composition-helpers.md) | TODO | V0, M13 |

### Photo + visual
| Wave | File | Status | Depends on |
|---|---|---|---|
| M18 | [Photo feedback / selfie comparison](waves/m18-photo-feedback.md) | TODO | V0, M10 |
