...
> **Wave S queued (2026-05-15):** Audit on 2026-05-15 (mobile Gemini integration + web reference + AddPiece perceived-speed + AI-pipeline security) surfaced gaps Wave R did not touch. Queued as [`docs/launch/waves/s-fast-smart-secure-ai.md`](waves/s-fast-smart-secure-ai.md) — 3 themed PRs (S-A security hardening · S-B structured output + context caching · S-C perceived-speed wins incl. analyze-prefetch in Step 1 + early-nav Step 2→3 + skeleton form + optional streaming). Edge-fn only for S-A/S-B; mobile-only for S-C. No migrations. Status: TODO. Pointer flips to S after current R-x rollover completes.
