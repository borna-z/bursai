...
DROP POLICY IF EXISTS "Users can view own feedback" ON public.outfit_feedback;
...
DROP POLICY IF EXISTS "Users can delete own feedback" ON public.outfit_feedback;
