...
// N10 hygiene marker: Stripe restore-subscription endpoint. Mobile uses RC.restorePurchases().
...
serve(async (req) => {
  ...
  console.warn("[deprecated] web-only Stripe edge function called", { fn: "restore_subscription" });
