...
const GEMINI_TEXT_API_URL = Deno.env.get("GEMINI_TEXT_URL_OVERRIDE") ?? `https://generativelanguage.googleapis.com/v1beta/models/${GEMINI_TEXT_MODEL}:generateContent`;
