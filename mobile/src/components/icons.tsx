...
// M20 — chain-link glyph for the "Import from link" entry on
// AddPieceStep1. Two interlocking arcs at the standard 1.5 stroke
// weight, matching the editorial set. Lucide-derived `Link2` shape.
export const LinkIcon = ({ size = 22, color = '#000' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
