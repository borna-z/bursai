...
export const sv: Record<string, string> = {
  ...
  'styleMe.formality.loungewear': 'Hemmaplagg',
  'styleMe.formality.casual': 'Vardagligt',
  'styleMe.formality.smartCasual': 'Smart casual',
  'styleMe.formality.business': 'Affärsmässigt',
  'styleMe.formality.formal': 'Formellt',
  ...
  // ─── Audit FIX 4 (2026-05-18) — Settings prenumerationskort. ────────
  'settings.subscription.eyebrow': 'Prenumeration',
  'settings.subscription.free': 'Gratisplan',
  'settings.subscription.trial': 'Provperiod aktiv',
  'settings.subscription.trialEnds': 'Slutar {date}',
  'settings.subscription.premium': 'Premium',
  'settings.subscription.renews': 'Förnyas {date}',
  'settings.subscription.monthly': 'Månadsvis',
  'settings.subscription.yearly': 'Årsvis',
  'settings.subscription.upgrade': 'Uppgradera',

  // ─── Audit FIX 6 (2026-05-18) — Filterskärm i18n. ───────────────────
  'filters.title': 'Filter',
  'filters.reset.label': 'Återställ',
  'filters.reset.aria': 'Återställ filter',
  'filters.apply.label': 'Använd filter',
  'filters.apply.withCount': 'Använd filter · {count}',
  'filters.section.category': 'Kategori',
  'filters.section.color': 'Färg',
  'filters.section.material': 'Material',
  'filters.section.fit': 'Passform',
  'filters.section.season': 'Säsong',
  'filters.section.sort': 'Sortera',
  'filters.category.outerwear': 'Ytterkläder',
  'filters.category.tops': 'Toppar',
  'filters.category.bottoms': 'Byxor & kjolar',
  'filters.category.shoes': 'Skor',
  'filters.category.dress': 'Klänningar',
  'filters.category.accessories': 'Accessoarer',
  'filters.material.cotton': 'Bomull',
  'filters.material.linen': 'Linne',
  'filters.material.wool': 'Ull',
  'filters.material.silk': 'Siden',
  'filters.material.leather': 'Läder',
  ...
  'filters.fit.loose': 'Lös',
  'filters.fit.oversized': 'Oversized',
  'filters.season.spring': 'Vår',
  'filters.season.summer': 'Sommar',
  'filters.season.autumn': 'Höst',
  'filters.season.winter': 'Vinter',
  'filters.sort.nameAsc': 'Namn A–Ö',
  'filters.sort.mostWorn': 'Mest buren',
  'filters.sort.recentAdded': 'Nyligen tillagd',
  'filters.sort.leastWorn': 'Minst buren',
  'filters.sort.recentWorn': 'Nyligen buren',
  'filters.color.cream': 'Creme',
  'filters.color.beige': 'Beige',
  'filters.color.camel': 'Kamel',
  'filters.color.brown': 'Brun',
  'filters.color.olive': 'Oliv',
  'filters.color.navy': 'Marinblå',
  'filters.color.charcoal': 'Koks',
  'filters.color.black': 'Svart',
  'filters.color.white': 'Vit',
  'filters.color.grey': 'Grå',
  'filters.color.rust': 'Rost',
  'filters.color.gold': 'Guld',
