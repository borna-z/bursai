...
export const en: Record<string, string> = {
  ...
  'styleMe.formality.loungewear': 'Loungewear',
  ...
  'livescan.title': 'Scan piece',
  'livescan.eyebrow': 'Live scan',
  'livescan.hint.searching': 'Looking for a garment...',
  'livescan.hint.low_light': 'Bring more light onto the garment',
  'livescan.hint.too_close': 'Move the camera back a little',
  'livescan.hint.too_far': 'Move the camera closer',
  'livescan.hint.not_centered': 'Center the garment in the frame',
  'livescan.hint.ready': 'Hold still...',
  'livescan.banner.havingTrouble': 'Having trouble — try better lighting',
  'livescan.toast.exit': '{count} pieces added — finishing up in the background',
  'livescan.toast.creditsExhausted': "You're out of render credits — saved without studio quality",
  'livescan.tile.retry': 'Retry',
  'livescan.tile.discard': 'Discard',
  'livescan.error.compress_failed': "Couldn't prepare the photo",
  'livescan.error.upload_failed': "Couldn't upload the photo",
  'livescan.error.analyze_rate_limit': 'Rate limit — try again in a moment',
  'livescan.error.analyze_auth': 'Session expired',
  'livescan.error.analyze_subscription': 'Subscription required',
  'livescan.error.analyze_http': "Couldn't analyze the photo",
  'livescan.error.analyze_unknown': "Couldn't analyze the photo",
  'livescan.error.multi_garment': 'Multiple garments — tap to pick one',
  ...
  'livescan.review.untitled': 'Untitled piece',
  'livescan.review.eyebrow.review': 'Review · ready to save',
  'livescan.review.eyebrow.saving': 'Saving',
  'livescan.review.eyebrow.saved': 'Saved',
  'livescan.review.eyebrow.skipped': 'Skipped',
  'livescan.review.eyebrow.failed': 'Couldn’t save',
  'livescan.review.saveStudio.label': 'Save with studio render',
  'livescan.review.saveStudio.body': 'Saves the cutout now; studio image renders in the background.',
  'livescan.review.saveOriginal.label': 'Save original cutout',
  'livescan.review.saveOriginal.body': 'Keeps the on-device cutout — no studio render queued.',
  'livescan.review.skip.label': 'Skip this photo',
  'livescan.review.skip.aria': 'Skip — discard this photo without saving',
  'livescan.review.saving': 'Saving…',
  'livescan.review.savedStudio': 'Saved · studio image rendering in the background.',
  'livescan.review.savedOriginal': 'Saved with the on-device cutout.',
  ...
  // ─── Audit FIX 4 (2026-05-18) — real Settings subscription card. ────
  'settings.subscription.eyebrow': 'Subscription',
  'settings.subscription.free': 'Free plan',
  'settings.subscription.trial': 'Trial active',
  'settings.subscription.trialEnds': 'Trial ends {date}',
  'settings.subscription.premium': 'Premium',
  'settings.subscription.renews': 'Renews {date}',
  'settings.subscription.monthly': 'Monthly',
  'settings.subscription.yearly': 'Annual',
  'settings.subscription.upgrade': 'Upgrade',

  // ─── Audit FIX 6 (2026-05-18) — FiltersScreen i18n. ─────────────────
  'filters.title': 'Filters',
  'filters.reset.label': 'Reset',
  'filters.reset.aria': 'Reset filters',
  'filters.apply.label': 'Apply filters',
  'filters.apply.withCount': 'Apply filters · {count}',
  'filters.section.category': 'Category',
  'filters.section.color': 'Color',
  'filters.section.material': 'Material',
  'filters.section.fit': 'Fit',
  'filters.section.season': 'Season',
  'filters.section.sort': 'Sort by',
  'filters.category.outerwear': 'Outerwear',
  'filters.category.tops': 'Tops',
  'filters.category.bottoms': 'Bottoms & skirts',
  'filters.category.shoes': 'Shoes',
  'filters.category.dress': 'Dresses',
  'filters.category.accessories': 'Accessories',
  'filters.material.cotton': 'Cotton',
  'filters.material.linen': 'Linen',
  'filters.material.wool': 'Wool',
  'filters.material.silk': 'Silk',
  'filters.material.leather': 'Leather',
  'filters.material.denim': 'Denim',
  'filters.material.cashmere': 'Cashmere',
  'filters.material.synthetic': 'Synthetic',
  'filters.fit.slim': 'Slim',
  'filters.fit.regular': 'Regular',
  'filters.fit.loose': 'Loose',
  'filters.fit.oversized': 'Oversized',
  'filters.season.spring': 'Spring',
  'filters.season.summer': 'Summer',
  'filters.season.autumn': 'Autumn',
  'filters.season.winter': 'Winter',
  'filters.sort.nameAsc': 'Name A–Z',
  'filters.sort.mostWorn': 'Most worn',
  'filters.sort.recentAdded': 'Recently added',
  'filters.sort.leastWorn': 'Least worn',
  'filters.sort.recentWorn': 'Recently worn',
  'filters.color.cream': 'Cream',
  'filters.color.beige': 'Beige',
  'filters.color.camel': 'Camel',
  'filters.color.brown': 'Brown',
  'filters.color.olive': 'Olive',
  'filters.color.navy': 'Navy',
  'filters.color.charcoal': 'Charcoal',
  'filters.color.black': 'Black',
  'filters.color.white': 'White',
  'filters.color.grey': 'Grey',
  'filters.color.rust': 'Rust',
  'filters.color.gold': 'Gold',
